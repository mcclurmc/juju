...
class ParseTest(TestCase):
    ...
    def test_mysql_sample(self):
        ...
        self.assertEqual(
            ...
            {"interface": "mysql", "limit": None, "optional": False})
    ...
    def test_riak_sample(self):
        ...
        self.assertEqual(
            metadata.peers["ring"],
            {"interface": "riak", "limit": 1, "optional": False})
        self.assertEqual(
            metadata.provides["endpoint"],
            {"interface": "http", "limit": None, "optional": False})
        self.assertEqual(
    ...
    def test_wordpress_sample(self):
        ...
        self.assertEqual(
            ...
            {"interface": "mysql", "limit": 1, "optional": False})
        self.assertEqual(
            metadata.requires["cache"],
            {"interface": "varnish", "limit": 2, "optional": True})
    ...
    def test_interface_expander(self):
        ...
        self.assertEqual(
            ...
            {"interface": "http", "limit": 2, "optional": False})
        self.assertEqual(
            expander.coerce(
                {"interface": "http", "optional": True},
                ["provides"]),
            {"interface": "http", "limit": None, "optional": True})
        ...
        self.assertRaises(
            SchemaError,
            expander.coerce,
            {"interface": "http", "optional": None}, ["provides"])
        self.assertRaises(
            SchemaError,
            expander.coerce,
        ...
        self.assertEqual(
            ...
            {"interface": "http", "limit": 1, "optional": False})
